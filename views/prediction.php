...
$svgVotes = "<abbr title='Nombre de votes'><img width='32px' height='32px' src='svg/people.svg'></abbr>";
$svgPoints = "<abbr title='Points dépensés'><img width='32px' height='32px' src='svg/points.svg'></abbr>";
$svgRatio = "<abbr title='Rendement (si vous gagnez, votre mise sera multipliée par ce coefficient)'><img width='32px' height='32px' src='svg/cup.svg'>";
$svgMax = "<abbr title='Record de mise'><img width='32px' height='32px' src='svg/podium.svg'></abbr>";
