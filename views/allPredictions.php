...
if(!$predictions){
    ...
    for($i = 0; $i < $count; $i++){
        ...
        echo "<tr><td>" . $id . "</td><td><a href=\"" . $link_prediction . "\">". $title . "</a></td><td><a href=\"" . $link_user . "\">" . $user . "</a></td><td>" . $created . "</td><td>" . $ended . "</td></tr>";
    }
}
echo "</table>";
echo "<hr>";
...
echo "</table>";
echo "<hr>";
$predictions = arraySQL("SELECT `id`, `title`, `user`, `created`, `ended`, `answer` FROM `predictions` WHERE `answer` IS NOT NULL ORDER BY `ended`;");
$count = $predictions?count($predictions):0;
...
if(!$predictions){
    ...
    for($i = 0; $i < $count; $i++){
        ...
        echo "<tr><td>" . $id . "</td><td><a href=\"" . $link_prediction . "\">". $title . "</a></td><td><a href=\"" . $link_user . "\">" . $user . "</a></td><td>" . $created . "</td><td>" . $ended . "</td><td>" . $answer . "</td></tr>";
    }
}
echo "</table>";
?>