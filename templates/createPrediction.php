...
<form action="controleur.php">
    ...
    <div id="choices">
        ...
        <input type="text" class="form-control" id="prediChoicesBox" name="choices[]" placeholder="Choix 1"
               required="required">
        <input type="text" class="form-control" id="prediChoicesBox" name="choices[]" placeholder="Choix 2"
               required="required">
    </div>
