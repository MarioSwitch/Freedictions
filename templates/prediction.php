...
$prediChoicesText = "<table class='table'><tr class='tr-choix'><th>Choix</th><th>Taux de vote</th><th>Votants</th><th>Points</th><th>Taux de victoire</th><th>Record de mise</th></tr>";
$count = 0;
...
if (SQLGetChamp("SELECT isAdmin FROM users WHERE username='$_SESSION[user]';") == 1) {
    $mode = "admin";
